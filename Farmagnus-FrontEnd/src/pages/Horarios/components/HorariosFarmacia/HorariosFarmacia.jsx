...
export const HorariosFarmacia = ({ data }) => {
      ...
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        >
          ...
          <Typography
            ...
            component={'p'}
          >
            Configure os horários de funcionamento da farmácia para cada dia da semana. Você pode
            adicionar múltiplos intervalos de horário para cada dia.
          </Typography>
        </Box>
